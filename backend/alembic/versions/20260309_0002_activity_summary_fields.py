...
def upgrade() -> None:
    ...
    op.add_column(
        "activities",
        sa.Column("moving_time_display", sa.String(length=32), nullable=True),
    )
    op.add_column(
        "activities",
        sa.Column(
            "average_speed_kph", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    )
    op.add_column(
        "activities",
    ...
    op.add_column(
        "activities",
        sa.Column("average_pace_display", sa.String(length=16), nullable=True),
    )
    op.add_column(
        "activities",
        sa.Column("summary_metric_display", sa.String(length=32), nullable=True),
    )
    op.add_column(
        "activities",
        sa.Column("difficulty_score", sa.Numeric(precision=12, scale=4), nullable=True),
    )
