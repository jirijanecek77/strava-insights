...
def upgrade() -> None:
    op.create_table(
        ...
        sa.UniqueConstraint(
            "strava_athlete_id", name=op.f("uq_users_strava_athlete_id")
        ),
    )
    op.create_table(
        "user_profiles",
    ...
    op.create_table(
        ...
        sa.Column(
            "average_speed_mps", sa.Numeric(precision=10, scale=4), nullable=True
        ),
        sa.Column("max_speed_mps", sa.Numeric(precision=10, scale=4), nullable=True),
        sa.Column(
            "average_heartrate_bpm", sa.Numeric(precision=6, scale=2), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_activities_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_activities")),
        sa.UniqueConstraint(
            "strava_activity_id", name=op.f("uq_activities_strava_activity_id")
        ),
    )
    op.create_index(
        "ix_activities_user_start_date_desc",
        "activities",
        ["user_id", "start_date_utc"],
        unique=False,
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "time_stream", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "distance_stream", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "latlng_stream", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "altitude_stream", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "heartrate_stream", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "derived_series", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "interval_analysis", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.ForeignKeyConstraint(
            ["activity_id"],
            ["activities.id"],
            name=op.f("fk_activity_streams_activity_id_activities"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_activity_streams")),
        sa.UniqueConstraint(
            "activity_id", name=op.f("uq_activity_streams_activity_id")
        ),
    )
    op.create_table(
        "period_summaries",
        ...
        sa.Column(
            "total_distance_meters", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        ...
        sa.Column(
            "total_difficulty_score", sa.Numeric(precision=12, scale=4), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_period_summaries_user_id_users")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["activity_id"],
            ["activities.id"],
            name=op.f("fk_best_efforts_activity_id_activities"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_best_efforts_user_id_users")
        ),
    ...
    op.create_index(
        ...
        "best_efforts",
        ["user_id", "sport_type", "effort_code"],
        unique=False,
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_sync_jobs_user_id_users")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_sync_checkpoints_user_id_users")
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_period_summaries_user_sport_period", table_name="period_summaries"
    )
