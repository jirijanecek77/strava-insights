from dash_apps.app.utils.interval import extract_intervals
...
def test_extract_intervals_within_range():
    ...
    expected_intervals = [
        {"distance_km": [0, 1], "pace": [3.5, 3.6], "bpm": [150, 155]},
        {"distance_km": [4, 5, 6], "pace": [3.9, 3.8, 3.6], "bpm": [158, 157, 159]},
    ]
...
def test_extract_intervals_above_threshold():
    ...
    upper_bound = float(
        "inf"
    )  # Use infinity for the upper bound to cover all values above the threshold

    expected_intervals = [
        {"distance_km": [2, 3], "pace": [4.1, 4.2], "bpm": [160, 162]},
        {"distance_km": [6], "pace": [4.0], "bpm": [159]},
    ]
