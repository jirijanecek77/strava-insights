    ...
    return (
        <div className="activity-detail">
            ...
            <div className="kpi-grid">
                ...
                <MetricTile label={detail.kpis.summary_metric_kind === "speed" ? "Avg Speed" : "Avg Pace"} value={formatSummaryMetricDisplay(detail.kpis.summary_metric_display, detail.kpis.summary_metric_kind)}/>
